package com.assingment.scalableweb.configuration;
...
public class ScalableWebApplicationConfiguration {
    ...
    private ApiInfo metaData() {
        return new ApiInfo(
                "Scalable Web",
                "Scalable Web for comparing 2 JSON in Base64 format",
                "1.0",
                "Terms of service",
                new Contact("Saurabh Oza", "https://onlyfullstack.blogspot.com/p/about-me_21.html",
                		"saurabh.s.oza@gmail.com"),
